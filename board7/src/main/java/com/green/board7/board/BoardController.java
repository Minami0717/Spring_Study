...
public class BoardController {
    ...
    @PostMapping
    @Operation(summary = "글등록", description = "글 등록할 수 있습니다.")
    ...
    @GetMapping
    public List<BoardVo> getBoard(@RequestParam(defaultValue = "1") @Min(value = 1, message = "1 이상") int page, @RequestParam(defaultValue = "30") int row) {
